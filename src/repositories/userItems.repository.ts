...
export interface UserItemsRepository {
  ...
  update(id: string, data: Partial<Omit<NewUserItem, 'id' | 'userId' | 'itemId'>>): Promise<UserItem>;
  delete(id: string): Promise<void>;

  addItemToUserBacklog(userId: string, itemId: string, order?: number): Promise<UserItem>;
  ...
  updateUserItemStatus(userId: string, itemId: string, status: UserItemStatus): Promise<UserItem>;
  updateUserItemRating(userId: string, itemId: string, rating: number): Promise<UserItem>;
  updateUserItemOrder(userId: string, itemId: string, order: number): Promise<UserItem>;
